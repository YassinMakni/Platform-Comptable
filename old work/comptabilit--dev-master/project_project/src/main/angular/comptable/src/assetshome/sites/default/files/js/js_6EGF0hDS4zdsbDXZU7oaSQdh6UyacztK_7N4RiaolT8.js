...
jQuery(function() {
	...
	var lat = jQuery('#inobi-map').data('lat');
	var lng = jQuery('#inobi-map').data('lang');
    // Create the map
...
// -------------------- Navigation Scroll
    ...
    if(jQuery('#mega-menu-wrapper').length) {
      ...
      jQuery('#mega-menu-wrapper .nav li.dropdown-holder').append('<i class="fa fa-caret-down icon" aria-hidden="true"></i>');
